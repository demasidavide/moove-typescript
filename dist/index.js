...
citta1.mezziDisponibili.forEach((element) => {
    if (element.stato) {
        console.log(citta1.nome, "mezzo disponibile", element.tipo, element.idMezzo);
    }
    else {
        console.log(citta1.nome, "mezzo NON disponibile", element.tipo, element.idMezzo);
    }
});
citta2.mezziDisponibili.forEach((element) => {
    if (element.stato) {
        console.log(citta2.nome, "mezzo disponibile", element.tipo, element.idMezzo);
    }
    else {
        console.log(citta2.nome, "mezzo NON disponibile", element.tipo, element.idMezzo);
    }
});
//creazione utenti
const utente1 = new cliente("mario", "rossi", "mariorossi@gmail.x", "googlepay");
